/**
 * Production API Configuration for PowerBuy Application
 * Replace 'yourdomain.com' with your actual domain
 */

const API_CONFIG = {
    // Base URL for the PowerBuy API - CHANGE THIS TO YOUR DOMAIN
    baseURL: 'https://api.yourdomain.com/api/v1',
    // OR if API is on same domain: 'https://yourdomain.com/api/v1'
